<template>
  <section class="mt-40 pb-40 relative dark:bg-gray-800 bg-gray-200">
    <div
    ...
    >
      ...
      >
        <polygon
          class="text-gray-200 fill-current dark:bg-gray-800"
    ...
    <div class="container mx-auto" id="about">
      <div class="flex flex-wrap items-center">
        ...
        >
          <div
            class="relative flex flex-col min-w-0 break-words dark:bg-gray-700 bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-600"
          >
            <img
              alt="..."
            ...
            <blockquote class="relative p-8 mb-4">
              ...
              >
                <polygon
                  ...
                  class="text-pink-600 fill-current dark:bg-gray-700"
                ></polygon>
              </svg>
              ...
              <div class="relative flex flex-col mt-4">
                <div class="px-4 py-5 flex-auto">
                  ...
                  <p class="mb-4 text-gray-600">
                    Tailwind Starter Kit comes with a huge number of Fully Coded
                    CSS components.
                  </p>
                </div>
              </div>
              ...
              <div class="relative flex flex-col min-w-0">
                <div class="px-4 py-5 flex-auto">
                  ...
                  <p class="mb-4 text-gray-600">
                    ...
                    is to to work with Tailwind Starter Kit.
                  </p>
                </div>
              </div>
            </div>
